...
class HighResult extends StatefulWidget {
  final int userId;

  const HighResult({super.key, required this.userId});

  @override
  _HighResultState createState() => _HighResultState();
}

class _HighResultState extends State<HighResult> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20.0),
              const Text(
                'Berdasarkan jawaban Anda, indikasi autisme pada anak tergolong tinggi.',
                style: TextStyle(color: Colors.white),
              ),
              const SizedBox(height: 20.0),
              const Text(
